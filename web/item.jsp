		...
		<div class="row">
			<div class="col">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						<li><a href="home">Home</a></li>
						<li><a href="productcontrol"><i class="fa fa-angle-right" aria-hidden="true"></i>Shop</a></li>
						<li class="active"><a href="item"><i class="fa fa-angle-right" aria-hidden="true"></i>Single Product</a></li>
					</ul>
				</div>
			...
			<div class="col-lg-5">
				<div class="product_details">
					...
					<div class="quantity d-flex flex-column flex-sm-row align-items-sm-center">
						...
						<div class="red_button add_to_cart_button"><a href="Cart?ProductID=${product.id}">add to cart</a></div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="footer_nav_container">
						<div class="cr">©2023 All Rights Reserverd. Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://github.com/">Nguyễn Tuấn Anh</a> &amp; distributed by <a href="home">ColoShop</a></div>
					</div>
				</div>
			</div>
		</div>
